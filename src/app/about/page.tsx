      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start md:items-center gap-10 md:gap-16">
          ...
          <motion.div variants={itemVariants} className="flex-1 max-w-4xl">
            ...
            >
              EX ENGINEERING PROFESSIONAL, AUTHOR, READER.
            </motion.p>
            <motion.p
              variants={itemVariants}
...
As a well-regarded figure in contemporary Indian literature, Manoj Kumar Sharma continues to inspire readers with stories that are both deeply personal and universally relatable. His transition from a technical career to a literary one stands as a testament to the enduring power of curiosity, creativity, and the human spirit.
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center md:gap-12">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="max-w-4xl mx-auto px-6 text-justify">
              Manoj Kumar Sharma stands as a towering figure in contemporary Indian literature, celebrated for his empathetic storytelling and socially conscious themes. With over 20 prestigious literary awards to his name—including Yatha Katha, Aghaaz, Aaweg, ICMDR, and the Azadi Ka Amrit Mahotsav series—Sharma has earned widespread acclaim for his masterworks Mirrro and Me No Pause Me Play. His writing delves into the nuanced realities of female life, global peace, and the human condition, addressing societal atrocities with sensitivity and insight. Known for a style that is both deeply engaging and easily accessible, Sharma connects with readers across generations. His personal life is a cornerstone of his creative inspiration: he has lovingly dedicated his books to his late mother, Mrs. Hemlata Sharma, and often shares thoughtful exchanges with his father. His wife and son serve as his most trusted critics, offering unwavering support and honest feedback that enrich his work. Featured in over 200 media outlets and newspapers, Sharma’s literary contributions have not only shaped public discourse but also uplifted his community, marking him as a beacon of cultural and intellectual excellence.
        ...
        <motion.div variants={itemVariants} className="mt-16 text-amber-900">
          ...
          >
            <li>
              Writer and Co-Producer of Me No Pause Me Play, a Hindi film that tackles menopause and talks about female identity.
